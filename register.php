        ...
        <form action="auth/register-handler.php" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" required placeholder="Min 8 char with 1 special char (87654321!)" autocomplete="new-password">
                </div>
            ...
            <div id="userFields">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phoneInput" placeholder="10-digit number (e.g., 9841234567)">
                    </div>
...
// Clear email and password fields on page load to prevent browser autofill
